$(document).ready(function () {
          ...
          $.ajax({
            ...
            success: function (response) {  
              if (response.status == success_code) {
                openNotificationBox("Delete loan successfully!", 1, "primary", false, doNothing);
                getForCompletedList();
              } else {
  ...
  var getForRegisteredList = function(id_host) {
    $(".have-element").hide();
  ...
  var getForOnGoingList = function(id_host) {
    $(".have-element").hide();
    $(".not-have-element").show();
  ...
  var getForCompletedList = function(id_host) {
    $(".have-element").hide();
    $(".not-have-element").show();
  ...
  getForOnGoingList(id_host);

  callOnClick(".click-registered", function() {
    getForRegisteredList(id_host);
  });
